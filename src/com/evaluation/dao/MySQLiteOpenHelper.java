 ...
 */
//修改的SQLiteOpenHelper,可以自定义数据库路径(修改了SQLiteOpenHelper的getDatabaseLocked)
public abstract class MySQLiteOpenHelper {
     ...
     */
    public MySQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
            ...
            if (mEnableWriteAheadLogging != enabled) {
                if (mDatabase != null && mDatabase.isOpen() && !mDatabase.isReadOnly()) {
                    if (enabled) {
                        ...
                        try {
							Method method = mDatabase.getClass().getMethod("disableWriteAheadLogging");
							method.invoke(mDatabase);
						} catch (Exception e) {
							// TODO Auto-generated catch block
							Log.e(TAG, "invoke SQLiteDatabase.disableWriteAheadLogging");
							e.printStackTrace();
						}
                    }
                }
        ...
        try {
            ...
            if (db != null) {
                if (writable && db.isReadOnly()) {
                    ...
                    Method method;
					try {
						method = db.getClass().getMethod("reopenReadWrite");
						method.invoke(db);
					} catch (Exception e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
